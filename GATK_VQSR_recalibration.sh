...
if [ "$1" == "" ]
	...
	java -Xmx10g -jar ~/Bin/GATK3.30/GenomeAnalysisTK.jar -T VariantRecalibrator -l debug \
	-R /Users/meganm/Genomes/IPO323/Mycosphaerella_graminicola.allmasked.fa \
	--input $1 \
	-resource:known=false,training=true,truth=true,prior=20 /Users/meganm/Genomes/GATK_Variant_Detection/knownsnps.vcf \
	-an DP -an QD -an FS \
	-mode SNP \
...
#	-resource:known=false,training=true,truth=true,prior=8 /Users/meganm/Genomes/GATK_Variant_Detection/knownsnps.vcf \
