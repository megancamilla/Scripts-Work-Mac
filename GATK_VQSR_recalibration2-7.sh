...
if [ "$1" == "" ]
	...
	java -Xmx10g -jar ~/Bin/GATK2-7/dist/GenomeAnalysisTK.jar -T VariantRecalibrator -l debug \
	...
	java -Xmx10g -jar ~/Bin/GATK2-7/dist/GenomeAnalysisTK.jar -T ApplyRecalibration \
	-R /Users/meganm/Genomes/IPO323/Mycosphaerella_graminicola.allmasked.fa \
	--input $1 \
	-mode SNP \
	-recalFile $2.SNPs.recal \
