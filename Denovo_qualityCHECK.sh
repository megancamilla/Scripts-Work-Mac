...
bwa mem -H -M ~/Genomes/IPO323/Mycosphaerella_graminicola.allmasked.fa $INPATH > ""$ISOLATE"_denovo_Hardclip.sam"
#ckRes $? "bwa mem";
...
#bwa mem -t 4 $INPATH $PAIR1 $PAIR2 > "WAI"$ISOLATE".denovo_CHECK.sam"
#ckRes $? "bwa mem";
